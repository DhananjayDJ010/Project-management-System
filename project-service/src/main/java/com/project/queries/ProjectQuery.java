...
public class ProjectQuery {
	...
	public static final String query="select p.project_id as project_id,p.project_name as project_name,p.project_type as project_type,p.manager_id as manager_id,"+
...
" inner join sprint_details s on p.project_id=s.project_id inner join user_story_details u on s.id=u.sprint_id inner join"+
